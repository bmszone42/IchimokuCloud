...
ax3.bar(macd_df.index[::10], macd_df['MACD histogram'][::10], label='MACD histogram', width=0.02, color='purple', edgecolor='black', alpha=.5)

# # Plot the bar chart
# bars = ax3.bar(range(len(macd_df)), macd_df['MACD histogram'], label='MACD histogram', color='red', width=0.01, edgecolor='black', alpha=.5)
# threshold = .01
